...
export default class AdvancedSearchPage {
    ...
    productNameInputField: string = "#name";
    skuInputField: string = "#sku";
    descriptionInputField: string = "#description";
    shortDescriptionInputField: string = "#short_description";
    priceFromInputField: string = "input[name='price[from]']";
    priceToInputField: string = "input[name='price[to]']";
    searchBtn: string = ".search button[type='submit']";
